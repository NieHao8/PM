...
!function ($) {
    ...
    BootstrapTable.prototype.initContainer = function () {
        this.$container = $([
            '<div class="bootstrap-table">',
                ...
                //'<div class="clearfix" ></div><div class="fixed-table-pagination"></div>',
    ...
    BootstrapTable.prototype.initSort = function () {
        ...
        if (index !== -1) {
            this.data.sort(function (a, b) {
                ...
                //Hank 2017/02/22 : change aa type as String, number doesn't have localeCompare function 
                //if (aa.localeCompare(bb) === -1) {
                if (new String(aa).localeCompare(bb) === -1) {
                    return order * -1;
                }
    ...
    BootstrapTable.prototype.initToolbar = function () {
        ...
        if (this.options.showPaginationSwitch) {
            html.push(sprintf('<button class="btn btn-default" type="button" name="paginationSwitch" title="%s">',
                ...
                sprintf('<i class="%s %s"><span>Show All<span></i>', this.options.iconsPrefix, this.options.icons.paginationSwitchDown),
                '</button>');
        }
        ...
        if (this.options.showColumns) {
            html.push(sprintf('<div class="keep-open btn-group" title="%s">',
                ...
                sprintf('<i class="%s %s">Columns</i>', this.options.iconsPrefix, this.options.icons.columns),
    ...
    BootstrapTable.prototype.onSearch = function (event) {
        ...
        if (!this.options.defaultFilter && text === this.searchText) {
            return;
        }
    ...
    BootstrapTable.prototype.initBody = function (fixedScroll) {
        ...
        for (var i = this.pageFrom - 1; i < this.pageTo; i++) {
            ...
            $.each(this.header.fields, function (j, field) {
                ...
                //add the logic to get the value of "." ex : system.name => value = item['system']['name']
